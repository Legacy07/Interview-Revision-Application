...
public class JavaScriptAnswers extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String[] answersArray = getResources().getStringArray(R.array.javascript_answers);
