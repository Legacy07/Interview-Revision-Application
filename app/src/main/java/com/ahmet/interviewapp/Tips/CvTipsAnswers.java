...
public class CvTipsAnswers extends Fragment implements View.OnClickListener {
    ViewPager viewPager;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String[] answersArray = getResources().getStringArray(R.array.cvTopicsTips);
        String[] questionsArray = getResources().getStringArray(R.array.cvTopics);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.centerButton:
                ...
                manager.beginTransaction().replace(R.id.content_layout, cvTips).addToBackStack(null).commit();
                break;
        }
